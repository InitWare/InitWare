...
void FSPRG_GenMK(void *msk, void *mpk, const void *seed, size_t seedlen,
	unsigned secpar);
...
*/
void FSPRG_GenState0(void *state, const void *mpk, const void *seed,
	size_t seedlen);
...
void FSPRG_Seek(void *state, uint64_t epoch, const void *msk, const void *seed,
	size_t seedlen);
