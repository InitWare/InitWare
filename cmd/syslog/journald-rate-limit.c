...
static const int priority_map[] = {
	[LOG_EMERG] = 0, [LOG_ALERT] = 0, [LOG_CRIT] = 0, [LOG_ERR] = 1, [LOG_WARNING] = 2, [LOG_NOTICE] = 3, [LOG_INFO] = 3, [LOG_DEBUG] = 4
};
...
static void journal_rate_limit_group_free(JournalRateLimitGroup *g)
{
	...
	if (g->parent) {
		...
		IWLIST_REMOVE(JournalRateLimitGroup, bucket,
		    g->parent->buckets[g->hash % BUCKETS_MAX], g);
