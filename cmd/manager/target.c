...
static void target_set_state(Target *t, TargetState state)
{
	...
	if (state != old_state)
		log_debug("%s changed %s -> %s", UNIT(t)->id, target_state_to_string(old_state),
...
static int target_add_default_dependencies(Target *t)
{
	...
	static const UnitDependency deps[] = { UNIT_REQUIRES, UNIT_REQUIRES_OVERRIDABLE,
		UNIT_REQUISITE, UNIT_REQUISITE_OVERRIDABLE, UNIT_WANTS, UNIT_BINDS_TO,
		UNIT_PART_OF };
	...
	return unit_add_dependency_by_name(UNIT(t), UNIT_CONFLICTS, SPECIAL_SHUTDOWN_TARGET, NULL,
	    true);
}
