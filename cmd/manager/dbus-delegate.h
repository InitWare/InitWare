...
#ifndef DBUS_DELEGATE_H_
#define DBUS_DELEGATE_H_
...
extern const char bus_delegate_interface[];
extern const char bus_delegate_invalidating_properties[];

#endif /* DBUS_DELEGATE_H_ */
