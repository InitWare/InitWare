...
static int
method_get_unit(sd_bus *bus, sd_bus_message *message, void *userdata,
	sd_bus_error *error)
{
...
static int
method_get_unit_by_pid(sd_bus *bus, sd_bus_message *message, void *userdata,
	sd_bus_error *error)
{
	_cleanup_free_ char *path = NULL;
	Manager *m = userdata;
...
static int
method_load_unit(sd_bus *bus, sd_bus_message *message, void *userdata,
	sd_bus_error *error)
{
	_cleanup_free_ char *path = NULL;
	Manager *m = userdata;
...
static int
method_start_unit_generic(sd_bus *bus, sd_bus_message *message, Manager *m,
	JobType job_type, bool reload_if_possible, sd_bus_error *error)
{
	...
	return bus_unit_method_start_generic(bus, message, u, job_type,
		reload_if_possible, error);
}

static int
method_start_unit(sd_bus *bus, sd_bus_message *message, void *userdata,
	sd_bus_error *error)
{
	return method_start_unit_generic(bus, message, userdata, JOB_START,
		false, error);
}

static int
method_stop_unit(sd_bus *bus, sd_bus_message *message, void *userdata,
	sd_bus_error *error)
{
	return method_start_unit_generic(bus, message, userdata, JOB_STOP,
		false, error);
}

static int
method_reload_unit(sd_bus *bus, sd_bus_message *message, void *userdata,
	sd_bus_error *error)
{
	return method_start_unit_generic(bus, message, userdata, JOB_RELOAD,
		false, error);
}

static int
method_restart_unit(sd_bus *bus, sd_bus_message *message, void *userdata,
	sd_bus_error *error)
{
	return method_start_unit_generic(bus, message, userdata, JOB_RESTART,
		false, error);
}

static int
method_try_restart_unit(sd_bus *bus, sd_bus_message *message, void *userdata,
	sd_bus_error *error)
{
	return method_start_unit_generic(bus, message, userdata,
		JOB_TRY_RESTART, false, error);
}

static int
method_reload_or_restart_unit(sd_bus *bus, sd_bus_message *message,
	void *userdata, sd_bus_error *error)
{
	return method_start_unit_generic(bus, message, userdata, JOB_RESTART,
		true, error);
...
static int
method_reload_or_try_restart_unit(sd_bus *bus, sd_bus_message *message,
	void *userdata, sd_bus_error *error)
{
	return method_start_unit_generic(bus, message, userdata,
...
static int
method_start_unit_replace(sd_bus *bus, sd_bus_message *message, void *userdata,
	sd_bus_error *error)
{
	Manager *m = userdata;
	const char *old_name;
...
static int
method_kill_unit(sd_bus *bus, sd_bus_message *message, void *userdata,
	sd_bus_error *error)
{
	Manager *m = userdata;
	const char *name;
...
static int
method_reset_failed_unit(sd_bus *bus, sd_bus_message *message, void *userdata,
	sd_bus_error *error)
{
	Manager *m = userdata;
	const char *name;
...
static int
method_set_unit_properties(sd_bus *bus, sd_bus_message *message, void *userdata,
	sd_bus_error *error)
{
	Manager *m = userdata;
	const char *name;
...
static int
transient_unit_from_message(Manager *m, sd_bus_message *message,
	const char *name, Unit **unit, sd_bus_error *error)
{
	Unit *u;
	int r;
	...
	if (!IN_SET(u->load_state, UNIT_NOT_FOUND, UNIT_LOADED) ||
		...
		!strv_isempty(u->dropin_paths) || u->refs_by_target ||
...
static int
transient_aux_units_from_message(Manager *m, sd_bus_message *message,
	sd_bus_error *error)
{
	Unit *u;
	char *name = NULL;
...
static int
method_start_transient_unit(sd_bus *bus, sd_bus_message *message,
	void *userdata, sd_bus_error *error)
{
...
static int
method_get_job(sd_bus *bus, sd_bus_message *message, void *userdata,
	sd_bus_error *error)
{
	_cleanup_free_ char *path = NULL;
	Manager *m = userdata;
...
static int
method_cancel_job(sd_bus *bus, sd_bus_message *message, void *userdata,
	sd_bus_error *error)
{
	Manager *m = userdata;
	uint32_t id;
...
static int
method_clear_jobs(sd_bus *bus, sd_bus_message *message, void *userdata,
	sd_bus_error *error)
{
	Manager *m = userdata;
	int r;
...
static int
method_reset_failed(sd_bus *bus, sd_bus_message *message, void *userdata,
	sd_bus_error *error)
{
	Manager *m = userdata;
	int r;
...
static int
list_units_filtered(sd_bus *bus, sd_bus_message *message, void *userdata,
	sd_bus_error *error, char **states)
{
	...
	HASHMAP_FOREACH_KEY (u, k, m->units, i) {
		...
		r = sd_bus_message_append(reply, "(ssssssouso)", u->id,
			unit_description(u),
			unit_load_state_to_string(u->load_state),
			unit_active_state_to_string(unit_active_state(u)),
			unit_sub_state_to_string(u),
			following ? following->id : "", unit_path,
			u->job ? u->job->id : 0,
...
static int
method_list_units(sd_bus *bus, sd_bus_message *message, void *userdata,
	sd_bus_error *error)
{
...
static int
method_list_units_filtered(sd_bus *bus, sd_bus_message *message, void *userdata,
	sd_bus_error *error)
{
...
static int
method_list_jobs(sd_bus *bus, sd_bus_message *message, void *userdata,
	sd_bus_error *error)
{
	_cleanup_bus_message_unref_ sd_bus_message *reply = NULL;
	Manager *m = userdata;
	...
	HASHMAP_FOREACH (j, m->jobs, i) {
		...
		r = sd_bus_message_append(reply, "(usssoo)", j->id, j->unit->id,
...
static int
method_subscribe(sd_bus *bus, sd_bus_message *message, void *userdata,
	sd_bus_error *error)
{
	Manager *m = userdata;
	int r;
...
static int
method_unsubscribe(sd_bus *bus, sd_bus_message *message, void *userdata,
	sd_bus_error *error)
{
	Manager *m = userdata;
	int r;
...
static int
dump_impl(sd_bus *bus, sd_bus_message *message, void *userdata,
...
static int
reply_dump(sd_bus_message *message, char *dump)
{
	return sd_bus_reply_method_return(message, "s", dump);
}

static int
method_dump(sd_bus *bus, sd_bus_message *message, void *userdata,
	sd_bus_error *error)
{
...
static int
reply_dump_by_fd(sd_bus_message *message, char *dump)
{
...
static int
method_dump_by_fd(sd_bus *bus, sd_bus_message *message, void *userdata,
	sd_bus_error *error)
{
...
static int
method_reexecute(sd_bus *bus, sd_bus_message *message, void *userdata,
	sd_bus_error *error)
{
	Manager *m = userdata;
	int r;
...
static int
method_exit(sd_bus *bus, sd_bus_message *message, void *userdata,
	sd_bus_error *error)
{
	Manager *m = userdata;
	int r;
...
static int
method_halt(sd_bus *bus, sd_bus_message *message, void *userdata,
	sd_bus_error *error)
{
	Manager *m = userdata;
	int r;
...
static int
method_kexec(sd_bus *bus, sd_bus_message *message, void *userdata,
	sd_bus_error *error)
{
	Manager *m = userdata;
	int r;
...
static int
method_switch_root(sd_bus *bus, sd_bus_message *message, void *userdata,
	sd_bus_error *error)
{
...
static int
method_set_environment(sd_bus *bus, sd_bus_message *message, void *userdata,
	sd_bus_error *error)
{
...
static int
method_unset_environment(sd_bus *bus, sd_bus_message *message, void *userdata,
	sd_bus_error *error)
{
...
static int
method_unset_and_set_environment(sd_bus *bus, sd_bus_message *message,
	void *userdata, sd_bus_error *error)
{
...
static int
method_list_unit_files(sd_bus *bus, sd_bus_message *message, void *userdata,
	sd_bus_error *error)
{
	_cleanup_bus_message_unref_ sd_bus_message *reply = NULL;
	Manager *m = userdata;
...
static int
method_get_unit_file_state(sd_bus *bus, sd_bus_message *message, void *userdata,
	sd_bus_error *error)
{
	Manager *m = userdata;
	const char *name;
...
static int
method_get_default_target(sd_bus *bus, sd_bus_message *message, void *userdata,
	sd_bus_error *error)
{
...
static int
send_unit_files_changed(sd_bus *bus, void *userdata)
{
...
static int
reply_unit_file_changes_and_free(Manager *m, sd_bus *bus,
	sd_bus_message *message, int carries_install_info,
	UnitFileChange *changes, unsigned n_changes)
{
	...
	for (i = 0; i < n_changes; i++)
		if (unit_file_change_is_modification(changes[i].type)) {
			r = bus_foreach_bus(m, NULL, send_unit_files_changed,
				NULL);
			if (r < 0)
				log_debug_errno(r,
...
static int
method_enable_unit_files_generic(sd_bus *bus, sd_bus_message *message,
	Manager *m, const char *verb,
	int (*call)(UnitFileScope scope, UnitFileFlags flags,
	...
	bool carries_install_info, sd_bus_error *error)
{
	...
	return reply_unit_file_changes_and_free(m, bus, message,
		carries_install_info ? r : -1, changes, n_changes);
}

static int
method_enable_unit_files(sd_bus *bus, sd_bus_message *message, void *userdata,
	sd_bus_error *error)
{
	return method_enable_unit_files_generic(bus, message, userdata,
		"enable", unit_file_enable, true, error);
}

static int
method_reenable_unit_files(sd_bus *bus, sd_bus_message *message, void *userdata,
	sd_bus_error *error)
{
	return method_enable_unit_files_generic(bus, message, userdata,
		"enable", unit_file_reenable, true, error);
}

static int
method_link_unit_files(sd_bus *bus, sd_bus_message *message, void *userdata,
	sd_bus_error *error)
{
	return method_enable_unit_files_generic(bus, message, userdata,
		"enable", unit_file_link, false, error);
}

static int
unit_file_preset_without_mode(UnitFileScope scope, UnitFileFlags flags,
	const char *root_dir, char **files, UnitFileChange **changes,
	unsigned *n_changes)
{
...
static int
method_preset_unit_files(sd_bus *bus, sd_bus_message *message, void *userdata,
	sd_bus_error *error)
{
	return method_enable_unit_files_generic(bus, message, userdata,
		"enable", unit_file_preset_without_mode, true, error);
}

static int
method_mask_unit_files(sd_bus *bus, sd_bus_message *message, void *userdata,
	sd_bus_error *error)
{
	return method_enable_unit_files_generic(bus, message, userdata,
		"disable", unit_file_mask, false, error);
}

static int
method_preset_unit_files_with_mode(sd_bus *bus, sd_bus_message *message,
	void *userdata, sd_bus_error *error)
{
	_cleanup_strv_free_ char **l = NULL;
	UnitFileChange *changes = NULL;
	...
	return reply_unit_file_changes_and_free(m, bus, message, r, changes,
		n_changes);
}

static int
method_disable_unit_files_generic(sd_bus *bus, sd_bus_message *message,
	Manager *m, const char *verb,
	int (*call)(UnitFileScope scope, UnitFileFlags flags,
		const char *root_dir, char *files[], UnitFileChange **changes,
		unsigned *n_changes),
	sd_bus_error *error)
{
	...
	r = call(scope, runtime ? UNIT_FILE_RUNTIME : 0, NULL, l, &changes,
		&n_changes);
	if (r < 0)
		return r;
...
static int
method_disable_unit_files(sd_bus *bus, sd_bus_message *message, void *userdata,
	sd_bus_error *error)
{
	return method_disable_unit_files_generic(bus, message, userdata,
		"disable", unit_file_disable, error);
}

static int
method_unmask_unit_files(sd_bus *bus, sd_bus_message *message, void *userdata,
	sd_bus_error *error)
{
	return method_disable_unit_files_generic(bus, message, userdata,
		"enable", unit_file_unmask, error);
}

static int
method_set_default_target(sd_bus *bus, sd_bus_message *message, void *userdata,
	sd_bus_error *error)
{
	UnitFileChange *changes = NULL;
	unsigned n_changes = 0;
	...
	r = unit_file_set_default(scope, force ? UNIT_FILE_FORCE : 0, NULL,
		name, &changes, &n_changes);
	if (r < 0)
		return r;
...
static int
method_preset_all_unit_files(sd_bus *bus, sd_bus_message *message,
	void *userdata, sd_bus_error *error)
{
	UnitFileChange *changes = NULL;
	unsigned n_changes = 0;
...
static int
method_add_dependency_unit_files(sd_bus *bus, sd_bus_message *message,
	void *userdata, sd_bus_error *error)
{
	_cleanup_strv_free_ char **l = NULL;
	Manager *m = userdata;
	...
	r = sd_bus_message_read(message, "ssbb", &target, &type, &runtime,
		&force);
	if (r < 0)
		return r;
	...
	r = unit_file_add_dependency(scope, flags, NULL, l, target, dep,
		&changes, &n_changes);
	if (r < 0)
		return r;
...
static int
method_get_unit_file_links(sd_bus *bus, sd_bus_message *message, void *userdata,
	sd_bus_error *error)
{
...
const sd_bus_vtable bus_manager_vtable[] = { SD_BUS_VTABLE_START(0),
	...
	SD_BUS_PROPERTY("UnitPath", "as", NULL,
		offsetof(Manager, lookup_paths.unit_path),
		SD_BUS_VTABLE_PROPERTY_CONST),
...
static int
send_finished(sd_bus *bus, void *userdata)
{
	_cleanup_bus_message_unref_ sd_bus_message *message = NULL;
	...
	r = sd_bus_message_append(message, "tttttt", times[0], times[1],
...
static int
send_reloading(sd_bus *bus, void *userdata)
{
	_cleanup_bus_message_unref_ sd_bus_message *message = NULL;
	int r;
