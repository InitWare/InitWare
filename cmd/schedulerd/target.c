...
static void
target_set_state(Target *t, TargetState state)
{
...
static int
target_add_default_dependencies(Target *t)
{
	static const UnitDependency deps[] = { UNIT_REQUIRES,
		UNIT_REQUIRES_OVERRIDABLE, UNIT_REQUISITE,
		UNIT_REQUISITE_OVERRIDABLE, UNIT_WANTS, UNIT_BINDS_TO,
		UNIT_PART_OF };
	...
	return unit_add_dependency_by_name(UNIT(t), UNIT_CONFLICTS,
...
static int
target_coldplug(Unit *u, Hashmap *deferred_work)
{
	Target *t = TARGET(u);
...
static void
target_dump(Unit *u, FILE *f, const char *prefix)
{
	Target *t = TARGET(u);
...
static int
target_serialize(Unit *u, FILE *f, FDSet *fds)
{
	Target *s = TARGET(u);
...
static int
target_deserialize_item(Unit *u, const char *key, const char *value, FDSet *fds)
{
	Target *s = TARGET(u);
...
target_sub_state_to_string(Unit *u)
{
	assert(u);
...
const UnitVTable target_vtable = {
        ...
        .bus_interface = SVC_DBUS_INTERFACE ".Target",
