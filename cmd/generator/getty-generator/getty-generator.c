...
static int
add_symlink(const char *fservice, const char *tservice)
{
	char *from, *to;
	int r;
...
static int
add_serial_getty(const char *tty)
{
...
static int
add_container_getty(const char *tty)
{
	_cleanup_free_ char *n = NULL;
...
{
	static const char virtualization_consoles[] = "hvc0\0"
						      "xvc0\0"
						      "hvsi0\0"
						      "sclp_line0\0"
						      "ttysclp0\0"
