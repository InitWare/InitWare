...
static void dev_kmsg_record(Server *s, char *p, size_t l)
{
	...
	char *message = NULL, *syslog_priority = NULL, *syslog_pid = NULL, *syslog_facility = NULL,
	...
	if (s->kernel_seqnum) {
		...
		if (serial > *s->kernel_seqnum)
			server_driver_message(s, SD_MESSAGE_JOURNAL_MISSED,
			    "Missed %" PRIu64 " kernel messages", serial - *s->kernel_seqnum);
	...
	*e = 0;
	...
	server_dispatch_message(s, iovec, n, ELEMENTSOF(iovec), NULL, NULL, NULL, 0, NULL,
	    priority, 0);
