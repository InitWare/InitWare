...
static int
count_addresses(sd_bus_message *m, int af, unsigned *ret)
{
	unsigned c = 0;
	int r;
...
enum nss_status
_nss_mymachines_gethostbyname4_r(const char *name, struct gaih_addrtuple **pat,
...
enum nss_status
_nss_mymachines_gethostbyname3_r(const char *name, int af,
