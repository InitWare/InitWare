...
int address_new_static(Network *network, unsigned section, Address **ret) {
        ...
        IWLIST_APPEND(addresses, network->static_addresses, address);
...
void address_free(Address *address) {
        ...
        if (address->network) {
                IWLIST_REMOVE(addresses, address->network->static_addresses, address);
...
static int address_acquire(Link *link, Address *original, Address **ret) {
        ...
        IWLIST_PREPEND(addresses, link->pool_addresses, na);
