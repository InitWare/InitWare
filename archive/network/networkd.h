...
struct FdbEntry {
        ...
        IWLIST_FIELDS(FdbEntry, static_fdb_entries);
};
...
struct Network {
        ...
        IWLIST_HEAD(Address, static_addresses);
        IWLIST_HEAD(Route, static_routes);
        IWLIST_HEAD(FdbEntry, static_fdb_entries);
        ...
        IWLIST_FIELDS(Network, networks);
};
...
struct Address {
        ...
        IWLIST_FIELDS(Address, addresses);
};
...
struct AddressPool {
        ...
        IWLIST_FIELDS(AddressPool, address_pools);
};
...
struct Manager {
        ...
        IWLIST_HEAD(Network, networks);
        IWLIST_HEAD(AddressPool, address_pools);
