...
struct Manager {
        ...
        IWLIST_HEAD(DnsQuery, dns_queries);
        unsigned n_dns_queries;

        IWLIST_HEAD(DnsStream, dns_streams);
        ...
        IWLIST_HEAD(DnsServer, dns_servers);
        IWLIST_HEAD(DnsServer, fallback_dns_servers);
        DnsServer *current_dns_server;

        bool read_resolv_conf;
        usec_t resolv_conf_mtime;

        IWLIST_HEAD(DnsScope, dns_scopes);
