...
typedef int (*sd_resolve_getaddrinfo_handler_t)(sd_resolve_query *q, int ret,
	const struct addrinfo *ai, void *userdata);
typedef int (*sd_resolve_getnameinfo_handler_t)(sd_resolve_query *q, int ret,
	const char *host, const char *serv, void *userdata);
typedef int (*sd_resolve_res_handler_t)(sd_resolve_query *q, int ret,
	unsigned char *answer, void *userdata);
 ...
 * sd_resolve_res_done(). */
int sd_resolve_res_query(sd_resolve *resolve, sd_resolve_query **q,
	const char *dname, int clazz, int type,
 ...
 * query object. When the query is completed, you may retrieve the results using
 * sd_resolve_res_done(). */
int sd_resolve_res_search(sd_resolve *resolve, sd_resolve_query **q,
	const char *dname, int clazz, int type,
	sd_resolve_res_handler_t callback, void *userdata);
