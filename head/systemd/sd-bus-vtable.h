...
#define SD_BUS_METHOD(_member, _signature, _result, _handler, _flags)          \
	{                                                                      \
		...
		.x.method.member = _member, .x.method.signature = _signature,  \
		.x.method.result = _result, .x.method.handler = _handler,      \
	}

#define SD_BUS_SIGNAL(_member, _signature, _flags)                             \
	{                                                                      \
		.type = _SD_BUS_VTABLE_SIGNAL, .flags = _flags,                \
		.x.signal.member = _member, .x.signal.signature = _signature,  \
	}
...
#define SD_BUS_PROPERTY(_member, _signature, _get, _offset, _flags)            \
	{                                                                      \
		...
		.x.property.signature = _signature, .x.property.get = _get,    \
...
#define SD_BUS_WRITABLE_PROPERTY(_member, _signature, _get, _set, _offset,     \
	...
	{                                                                      \
		...
		.x.property.member = _member,                                  \
		.x.property.signature = _signature, .x.property.get = _get,    \
		.x.property.set = _set, .x.property.offset = _offset,          \
	}
