...
_printf_attr_(1, 0) static int fill_iovec_sprintf(const char *format, va_list ap, int extra,
    struct iovec **_iov)
{
	PROTECT_ERRNO;
	int r, n = 0, i = 0, j;
...
_public_ int sd_journal_stream_fd(const char *identifier, int priority, int level_prefix)
{
	union sockaddr_union sa = {
		...
		.un.sun_path = AbsDir_PkgRunState "/evlog/stdout",
	};
	int fd;
	char *header;
	size_t l;
...
_public_ int sd_journal_print_with_location(int priority, const char *file, const char *line,
...
_public_ int sd_journal_printv_with_location(int priority, const char *file, const char *line,
...
_public_ int sd_journal_send_with_location(const char *file, const char *line, const char *func,
    const char *format, ...)
{
	int r, i, j;
	va_list ap;
...
_public_ int sd_journal_sendv_with_location(const char *file, const char *line, const char *func,
...
_public_ int sd_journal_perror_with_location(const char *file, const char *line, const char *func,
    const char *message)
{
