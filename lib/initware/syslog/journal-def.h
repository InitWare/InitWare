...
enum {
        ...
        _OBJECT_COMPRESSED_MASK = OBJECT_COMPRESSED_XZ | OBJECT_COMPRESSED_LZ4,
};
...
enum {
        ...
        HEADER_INCOMPATIBLE_SUPPORTED       = HEADER_INCOMPATIBLE_COMPRESSED_XZ |
                                              HEADER_INCOMPATIBLE_KEYED_HASH |
                                              HEADER_INCOMPATIBLE_COMPACT,
#elif defined(HAVE_LZ4)
        HEADER_INCOMPATIBLE_SUPPORTED       = HEADER_INCOMPATIBLE_COMPRESSED_LZ4 |
                                              HEADER_INCOMPATIBLE_KEYED_HASH |
                                              HEADER_INCOMPATIBLE_COMPACT,
#else
...
#ifdef HAVE_GCRYPT
        HEADER_COMPATIBLE_SUPPORTED          = HEADER_COMPATIBLE_SEALED | HEADER_COMPATIBLE_SEALED_CONTINUOUS |
                                               HEADER_COMPATIBLE_TAIL_ENTRY_BOOT_ID,
#else
