...
int journal_file_append_entry(JournalFile *f, const dual_timestamp *ts,
	const struct iovec iovec[], unsigned n_iovec, uint64_t *seqno,
	Object **ret, uint64_t *offset);
...
static inline bool
JOURNAL_FILE_COMPRESS(JournalFile *f)
{
	assert(f);
