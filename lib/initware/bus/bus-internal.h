...
#define sd_event_source_set_prepare(...) 0
#define sd_event_source_set_priority(...) 0
#define sd_event_source_set_io_fd(...) 0
#define sd_event_source_unref(...) 0
#define sd_event_source_unref(...) 0
#define sd_event_exit(...) 0
#define sd_event_get_state(...) 0
#define sd_event_run(...) -EINVAL
#define sd_event_get_exit_code(...) 0
#define sd_event_ref(...) 0
#define sd_event_default(...) 0
...
static inline bool
BUS_IS_OPEN(enum bus_state state)
{
...
#define BUS_DONT_DESTROY(bus)                                                  \
	_cleanup_bus_unref_ _unused_ sd_bus *_dont_destroy_##bus = sd_bus_ref( \
	    bus)
