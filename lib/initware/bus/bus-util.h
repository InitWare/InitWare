...
int bus_verify_polkit(sd_bus *bus, sd_bus_message *m, const char *action,
    bool interactive, bool *_challenge, sd_bus_error *e);

int bus_verify_polkit_async(sd_bus *bus, Hashmap **registry, sd_bus_message *m,
...
int bus_property_get_tristate(sd_bus *bus, const char *path,
 ...
 * it to NULL here */
//assert_cc(sizeof(uid_t) == sizeof(uint32_t)); FIXME:
#define bus_property_get_uid ((sd_bus_property_get_t) NULL)

//assert_cc(sizeof(gid_t) == sizeof(uint32_t)); FIXME:
#define bus_property_get_gid ((sd_bus_property_get_t) NULL)

//assert_cc(sizeof(pid_t) == sizeof(uint32_t)); FIXME:
#define bus_property_get_pid ((sd_bus_property_get_t) NULL)

//assert_cc(sizeof(mode_t) == sizeof(uint32_t)); FIXME:
...
#define BUS_PROPERTY_DUAL_TIMESTAMP(name, offset, flags)                    \
	SD_BUS_PROPERTY(name, "t", bus_property_get_usec,                   \
	    (offset) + offsetof(struct dual_timestamp, realtime), (flags)), \
