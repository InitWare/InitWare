...
main(int argc, char *argv[])
{
	...
	assert_se(signature_is_valid("sssusa(uuubbba(uu)uuuu)a{u(uuuvas)}",
		false));
	...
	assert_se(
		signature_is_valid("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaad", false));
	assert_se(
		signature_is_valid("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaas", false));
	assert_se(!signature_is_valid("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaau",
		false));
