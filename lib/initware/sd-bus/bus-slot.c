...
sd_bus_slot *
bus_slot_allocate(sd_bus *bus, bool floating, BusSlotType type, size_t extra,
	void *userdata)
{
	sd_bus_slot *slot;
...
sd_bus_slot_ref(sd_bus_slot *slot)
{
...
_public_ void *
sd_bus_slot_get_userdata(sd_bus_slot *slot)
{
	assert_return(slot, NULL);
...
_public_ void *
sd_bus_slot_set_userdata(sd_bus_slot *slot, void *userdata)
{
	void *ret;
...
_public_ int
sd_bus_slot_set_description(sd_bus_slot *slot, const char *description)
{
...
_public_ int
sd_bus_slot_get_description(sd_bus_slot *slot, char **description)
{
	assert_return(slot, -EINVAL);
