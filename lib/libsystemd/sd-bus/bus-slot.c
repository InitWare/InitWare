...
void bus_slot_disconnect(sd_bus_slot *slot) {
        ...
        case BUS_FILTER_CALLBACK:
                ...
                IWLIST_REMOVE(callbacks, slot->bus->filter_callbacks, &slot->filter_callback);
                break;
        ...
        case BUS_NODE_CALLBACK:
                ...
                if (slot->node_callback.node) {
                        IWLIST_REMOVE(callbacks, slot->node_callback.node->callbacks, &slot->node_callback);
        ...
        case BUS_NODE_ENUMERATOR:
                ...
                if (slot->node_enumerator.node) {
                        IWLIST_REMOVE(enumerators, slot->node_enumerator.node->enumerators, &slot->node_enumerator);
                        slot->bus->nodes_modified = true;
        ...
        case BUS_NODE_OBJECT_MANAGER:
                ...
                if (slot->node_object_manager.node) {
                        IWLIST_REMOVE(object_managers, slot->node_object_manager.node->object_managers, &slot->node_object_manager);
                        slot->bus->nodes_modified = true;
        ...
        case BUS_NODE_VTABLE:
                ...
                if (slot->node_vtable.node) {
                        IWLIST_REMOVE(vtables, slot->node_vtable.node->vtables, &slot->node_vtable);
                        slot->bus->nodes_modified = true;
