...
static inline bool
barrier_i_aborted(Barrier *b)
{
	return b->barriers == BARRIER_I_ABORTED ||
		b->barriers == BARRIER_WE_ABORTED;
}

static inline bool
barrier_they_aborted(Barrier *b)
{
	return b->barriers == BARRIER_THEY_ABORTED ||
		b->barriers == BARRIER_WE_ABORTED;
}

static inline bool
barrier_we_aborted(Barrier *b)
{
	return b->barriers == BARRIER_WE_ABORTED;
}

static inline bool
barrier_is_aborted(Barrier *b)
{
	return b->barriers == BARRIER_I_ABORTED ||
...
static inline bool
barrier_place_and_sync(Barrier *b)
{
