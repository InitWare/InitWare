...
static bool
uid_range_intersect(UidRange *range, uid_t start, uid_t nr)
{
	assert(range);
...
static void
uid_range_coalesce(UidRange **p, unsigned *n)
{
	unsigned i, j;
...
static int
uid_range_compare(const void *a, const void *b)
{
...
int
uid_range_add(UidRange **p, unsigned *n, uid_t start, uid_t nr)
{
	bool found = false;
	UidRange *x;
	unsigned i;
...
int
uid_range_add_str(UidRange **p, unsigned *n, const char *s)
{
	uid_t start, nr;
	const char *t;
	int r;
...
int
uid_range_next_lower(const UidRange *p, unsigned n, uid_t *uid)
{
...
bool
uid_range_contains(const UidRange *p, unsigned n, uid_t uid)
{
	unsigned i;
