...
typedef int (*pty_event_t)(Pty *pty, void *userdata, unsigned int event,
...
int pty_attach_event(Pty *pty, sd_event *event, pty_event_t event_fn,
...
pid_t pty_fork(Pty **out, sd_event *event, pty_event_t event_fn,
