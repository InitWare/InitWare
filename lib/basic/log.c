...
void
log_close_journal(void)
{
	journal_fd = safe_close(journal_fd);
}

static int
log_open_journal(void)
{
	static const union sockaddr_union sa = {
		.un.sun_family = AF_UNIX,
...
log_open(void)
{
	...
	if ((log_target != LOG_TARGET_AUTO && log_target != LOG_TARGET_SAFE) ||
		getpid() == 1 || isatty(STDERR_FILENO) <= 0) {
...
void
log_set_target(LogTarget target)
{
	assert(target >= 0);
...
static int
write_to_console(int level, int error, const char *file, int line,
...
static int
write_to_syslog(int level, int error, const char *file, int line,
	const char *func, const char *object_field, const char *object,
	const char *buffer)
{
...
static int
write_to_kmsg(int level, int error, const char *file, int line,
	const char *func, const char *object_field, const char *object,
	const char *buffer)
{
...
static int
log_do_header(char *header, size_t size, int level, int error, const char *file,
	int line, const char *func, const char *object_field,
	const char *object)
{
	snprintf(header, size,
		...
		isempty(func) ? "" : func, isempty(func) ? "" : "\n",
...
static int
write_to_journal(int level, int error, const char *file, int line,
	const char *func, const char *object_field, const char *object,
	const char *buffer)
{
...
static int
log_dispatch(int level, int error, const char *file, int line, const char *func,
	const char *object_field, const char *object, char *buffer)
{
	assert(buffer);
	...
	do {
		...
		if (log_target == LOG_TARGET_AUTO ||
			log_target == LOG_TARGET_JOURNAL_OR_KMSG ||
			log_target == LOG_TARGET_JOURNAL) {
			k = write_to_journal(level, error, file, line, func,
				object_field, object, buffer);
			if (k < 0) {
				if (k != -EAGAIN)
					log_close_journal();
				log_open_kmsg();
...
int
log_internalv(int level, int error, const char *file, int line,
...
int
log_internal(int level, int error, const char *file, int line, const char *func,
	const char *format, ...)
{
	va_list ap;
	int r;
...
int
log_object_internalv(int level, int error, const char *file, int line,
	const char *func, const char *object_field, const char *object,
...
int
log_object_internal(int level, int error, const char *file, int line,
	const char *func, const char *object_field, const char *object,
	const char *format, ...)
{
	va_list ap;
...
static void
log_assert(int level, const char *text, const char *file, int line,
...
noreturn void
log_assert_failed(const char *text, const char *file, int line,
	const char *func)
{
...
void
log_assert_failed_return(const char *text, const char *file, int line,
	const char *func)
{
	PROTECT_ERRNO;
...
int
log_oom_internal(const char *file, int line, const char *func)
{
...
int
log_struct_internal(int level, int error, const char *file, int line,
	const char *func, const char *format, ...)
{
	char buf[LINE_MAX];
	bool found = false;
...
int
log_set_target_from_string(const char *e)
{
	LogTarget t;
...
int
log_set_max_level_from_string(const char *e)
{
	int t;
...
void
log_show_color(bool b)
{
	show_color = b;
}

bool
log_get_show_color(void)
{
	return show_color;
}

void
log_show_location(bool b)
{
	show_location = b;
}

bool
log_get_show_location(void)
{
	return show_location;
}

int
log_show_color_from_string(const char *e)
{
	int t;
...
int
log_show_location_from_string(const char *e)
{
	int t;
