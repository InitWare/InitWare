...
int
write_string_file_atomic_label(const char *fn, const char *line)
{
	int r;
...
int
write_env_file_label(const char *fname, char **l)
{
	int r;
...
int
fopen_temporary_label(const char *target, const char *path, FILE **f,
	char **temp_path)
{
	int r;
