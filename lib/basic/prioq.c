...
int
prioq_ensure_allocated(Prioq **q, compare_func_t compare_func)
{
	assert(q);
...
static void
swap(Prioq *q, unsigned j, unsigned k)
{
	void *saved_data;
	unsigned *saved_idx;
...
static unsigned
shuffle_up(Prioq *q, unsigned idx)
{
	assert(q);
...
static unsigned
shuffle_down(Prioq *q, unsigned idx)
{
	assert(q);
...
int
prioq_put(Prioq *q, void *data, unsigned *idx)
{
	struct prioq_item *i;
	unsigned k;
...
static void
remove_item(Prioq *q, struct prioq_item *i)
{
	struct prioq_item *l;
...
_pure_ static struct prioq_item *
find_item(Prioq *q, void *data, unsigned *idx)
{
	struct prioq_item *i;
...
int
prioq_remove(Prioq *q, void *data, unsigned *idx)
{
	struct prioq_item *i;
...
int
prioq_reshuffle(Prioq *q, void *data, unsigned *idx)
{
	struct prioq_item *i;
	unsigned k;
