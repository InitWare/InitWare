...
static void
test_path_is_mount_point(void)
{
	int fd, rt, rf, rlt, rlf;
	char tmp_dir[] = "/tmp/test-path-is-mount-point-XXXXXX";
	_cleanup_free_ char *file1 = NULL, *file2 = NULL, *link1 = NULL,
			    *link2 = NULL;
...
static void
test_find_binary(const char *self, bool local)
{
	char *p;
...
test_prefixes(void)
{
	static const char *values[] = { "/a/b/c/d", "/a/b/c", "/a/b", "/a", "",
		NULL };
	unsigned i;
	char s[PATH_MAX];
	bool b;
...
#define test(from_dir, to_path, expected)                                      \
	...
	test("//extra/////slashes///won't////fool///anybody//",
		"////extra///slashes////are/just///fine///",
		"../../../are/just/fine");
}

static void
test_strv_resolve(void)
{
