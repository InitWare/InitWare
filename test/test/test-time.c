...
test_parse_nsec(void)
{
	...
	assert_se(u ==
		5 * NSEC_PER_SEC + 500 * NSEC_PER_MSEC + 500 * NSEC_PER_USEC);
...
static void
test_format_timespan_one(usec_t x, usec_t accuracy)
{
	char *r;
...
static void
test_format_timespan(usec_t accuracy)
{
