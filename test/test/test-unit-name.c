...
#define expect(path, suffix, expected)                                         \
	{                                                                      \
		_cleanup_free_ char *k,                                        \
			*t = unit_name_from_path(path, suffix);                \
		puts(t);                                                       \
...
#define expect(pattern, path, suffix, expected)                                \
	...
	expect("waldo", "/waldo////quuix////", ".mount",
...
static void
test_unit_instance_is_valid(void)
{
...
static void
test_unit_prefix_is_valid(void)
{
...
static void
test_unit_name_change_suffix(void)
{
	char *r;
...
static void
test_unit_name_is_instance(void)
{
...
static void
test_unit_name_to_instance(void)
{
	char *instance;
	int r;
...
static void
test_unit_name_is_template(void)
{
