...
static void
test_utf8_encoded_valid_unichar(void)
{
...
static void
test_utf8_escaping_printable(void)
{
...
{
	char *a = NULL;
	const uint16_t utf16[] = { htole16('a'), htole16(0xd800), htole16('b'),
		htole16(0xdc00), htole16('c'), htole16(0xd801),
		htole16(0xdc37) };
