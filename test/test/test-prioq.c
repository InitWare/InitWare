...
static int
unsigned_compare(const void *a, const void *b)
{
...
static int
test_compare(const void *a, const void *b)
{
...
test_hash(const void *a, const uint8_t hash_key[HASH_KEY_SIZE])
{
...
static const struct hash_ops test_hash_ops = { .hash = test_hash,
