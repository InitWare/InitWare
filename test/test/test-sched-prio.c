...
main(int argc, char *argv[])
{
	...
	/* load idle ok */
	assert_se(manager_load_unit(m, "sched_idle_ok.service", NULL, NULL,
			  &idle_ok) >= 0);
	...
	/*
         ...
         */
	assert_se(manager_load_unit(m, "sched_idle_bad.service", NULL, NULL,
			  &idle_bad) >= 0);
	...
	/*
         ...
         */
	assert_se(manager_load_unit(m, "sched_rr_ok.service", NULL, NULL,
			  &rr_ok) >= 0);
	...
	/*
         ...
         */
	assert_se(manager_load_unit(m, "sched_rr_bad.service", NULL, NULL,
			  &rr_bad) >= 0);
	...
	/*
         ...
         */
	assert_se(manager_load_unit(m, "sched_rr_change.service", NULL, NULL,
			  &rr_sched) >= 0);
